...
class TestFilling45:
    ...
    def test_filling_add_oss(self):
        department = Request(method='post',
    ...
    def test_filling_add_oss_safe_life(self):
        ...
        shared_vars.COMMON_VAR["id_oss_safe_life"] = oss_safe_life.response.json()["id"]
    ...
    def test_filling_add_loaders(self):
        Request(method='post',
                endpoint='/api/v1/bootstrap/codes?validTill=' + time_now + '&depId=-1&isRecursive=true',
    ...
    def test_filling_add_profile_1(self):
        profile_android = Request(method='post',
                                  ...
                                  template='profiles_android_monitor_settings4_5',
