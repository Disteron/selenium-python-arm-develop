...
@allure.title('[API] Добавление приложения Monitor-5.0.0.0-kav')
...
class TestFillingMonitorKAVAndroid:
    ...
    def test_filling_upload_application_3(self):
        upload_response = Request(method='post',
                                  ...
                                  files={"name": "application",
                                         ...
                                         "path": "Monitor-5.0.0.0-kav-release.apk"}) \
            .fire()
        ...
        while end > time.time():
            ...
            if application_list:
                for application in application_list:
                    if application["version"] == "5.0.0.0-kav":
    ...
    def test_filling_add_pyp_monitor_kav_android(self):
        ...
        Request(method='post',
                ...
                title='Monitor-5.0.0.0-kav',
                app_version='5.0.0.0-kav',
